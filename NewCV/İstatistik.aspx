<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="İstatistik.aspx.cs" Inherits="NewCV.İstatistik" %>
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- //font-awesome icons -->
    <script src="web1/js/jquery2.0.3.min.js"></script>
    <script src="web1/js/modernizr.js"></script>
    <script src="web1/js/jquery.cookie.js"></script>
    <script src="web1/js/screenfull.js"></script>
    <script>
        $(function () {
    ...
    <!-- charts -->
    <script src="web1/js/raphael-min.js"></script>
    <script src="web1/js/morris.js"></script>
    <link rel="stylesheet" href="web1/css/morris.css">
    <!-- //charts -->
    <!--skycons-icons-->
    <script src="web1/js/skycons.js"></script>
    <!--//skycons-icons-->
</head>
<body class="dashboard-page">
    ...
    <section class="wrapper scrollable">
        ...
        <section class="title-bar">
            <div class="logo">
                <h1><a href="index.html"><img src="images/logo.png" alt="" />CV@PORTFOLYO</a></h1>
            </div>
 ...
 <div class="col-md-3 top-comment-grid">
    ...
    <div class="comments">
        ...
        <div class="comments-info">
            <h3><asp:Label ID="Label7" runat="server" Text="Label"></asp:Label></h3>
            <a href="#">Ortalama Yetenek</a>
        </div>
        <div class="clearfix"> </div>
    </div>
</div>
    ...
    <div class="comments likes">
        ...
        <div class="comments-info likes-info">
            <h3> <asp:Label ID="Label6" runat="server" Text="Label"></asp:Label></h3>
            <a href="#">Toplam İş</a>
        </div>
        <div class="clearfix"> </div>
    </div>
